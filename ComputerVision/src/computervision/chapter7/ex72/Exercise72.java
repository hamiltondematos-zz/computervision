...
//		DetectDescribePoint detDesc = FactoryDetectDescribe.sift(null,new ConfigSiftDetector(2,0,200,5),null,null);
	...
	public static void main( String args[] ) {
		...
		String dir = UtilIO.pathExample("c:/open/images/");

		BufferedImage imageA = UtilImageIO.loadImage(dir , "left4.jpg");
		BufferedImage imageB = UtilImageIO.loadImage(dir , "right4.jpg");
